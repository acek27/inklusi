...
@section('content')
        ...
        <div class="container">
                ...
                <div class="col-xl-6 col-lg-6">
                    <div class="tp-hero">
                        <div class="tp-hero__section-box">
                            <h4 class="tp-section-subtitle  wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".3s">
                                Best solution we offer you</h4>
                            <h2 class="tp-slider-title wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".6s">Make a
                                good plan & grow your business</h2>
                            <p class="wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".8s">We have almost 12+
                                years of experience for helping consulting services and business
                                solutions. </p>
                        </div>
            ...
            <div class="row">
                <div class="col-xl-5 col-lg-5 wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".3s">
                    <div class="tp-slider-exprience">
                        <div class="tp-slider-exprience__content">
                            ...
                            <p>“Lorem Ipsum is simply dummy text of printing and typesetting industry Ipsum is dummy
                                text of
                ...
                <div class="col-xl-7 col-lg-7">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 wow tpfadeUp" data-wow-duration=".7s"
                             data-wow-delay=".5s">
    ...
    <!-- tp-service-area-start -->
    <div class="tp-testimonial-area tp-testimonial-space p-relative testimonial-border-shape"
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-6 wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".7s">
                            <div class="tp-testimonial-item mb-30">
                                ...
                                <div class="tp-testimonial-item__text">
                                    <p>Our office is something we are pleased with. We consider it the little magnet; it
                                        is
                                        wanting to come here and afterward difficult to leave it.</p>
                                </div>
                                <div
                                    class="tp-testimonial-item__wrapper d-flex justify-content-between align-items-center">
                        ...
                        <div class="col-xl-12 col-lg-6 wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".9s">
                            <div class="tp-testimonial-item testimonial-bg-color-2 mb-30">
                                ...
                                <div class="tp-testimonial-item__text">
                                    <p>He works very smart always fast and ahead of time. He's also a team player
                                        Looking
                ...
                <div class="row gx-20">
                    <div class="col-xl-6 col-lg-6 wow tpfadeLeft" data-wow-duration=".7s" data-wow-delay=".4s">
                        <div class="tp-blog-item mb-30">
                            ...
                            <div class="tp-blog-item__blog-title">
                                <h4 class="tp-blog-title-lg"><a href="blog-details.html">How to Increase Your ROI
                                        Through scientific SEM?</a>
                                </h4>
                            </div>
                    ...
                    <div class="col-xl-6 col-lg-6 wow tpfadeRight" data-wow-duration=".7s" data-wow-delay=".7s">
                        <div class="tp-blog-item mb-30">
                            ...
                            <div class="tp-blog-item__blog-title">
                                <h4 class="tp-blog-title-lg"><a href="blog-details.html">ECommerce Marketing Statistics
                                        You Should Kno</a></h4>
                            </div>
                            <div class="tp-blog-item__button">
                                <div class="tp-link tp-link-green">
